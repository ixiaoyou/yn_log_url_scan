...
public class Tuple {
    ...
    public static class T4<A, B, C, D> implements Comparable<T4<A, B, C, D>> {
        ...
        public String toString() {
            return "(" + tuple.getFirst() + ", " + tuple.getSecond() + ", " + tuple.getThird() + ", " + fourth + ")";
        }
        ...
        public boolean equals(Object obj) {
            if (obj instanceof T4) {
                ...
                return (fourth == null ? o.fourth == null : fourth.equals(o.fourth)) && tuple.equals(o.tuple);
            }
            return false;
        }
    ...
    public static class T5<A, B, C, D, E> implements Comparable<T5<A, B, C, D, E>> {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof T5) {
                ...
                return (fifth == null ? o.fifth == null : fifth.equals(o.fifth)) && tuple.equals(o.tuple);
            }
            return false;
        }
